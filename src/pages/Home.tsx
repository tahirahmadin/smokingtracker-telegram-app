      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-2 text-center">
          ...
          <div className="flex justify-center gap-3">
            <button className="bg-gradient-to-r from-[#4CD7E7] to-[#4CD7E7]/80 text-white px-6 py-1.5 rounded-full text-sm font-medium shadow-lg shadow-[#4CD7E7]/20 border border-[#4CD7E7]/30">
              Normal
            </button>
            <button className="bg-gradient-to-r from-[#2A4B57] to-[#2A4B57]/80 text-gray-300 px-6 py-1.5 rounded-full text-sm font-medium shadow-lg shadow-[#2A4B57]/20 border border-[#2A4B57]/30">
              Boost
            </button>
          </div>
        </div>
        ...
        <div className="mx-3 mt-3 p-4 rounded-2xl bg-gradient-to-br from-[#1A1A1A]/80 to-black/100 backdrop-blur-xl border border-white/10 shadow-lg relative overflow-hidden">
          ...
          <h2 className="text-base font-medium relative z-10 text-white/90">
            Weekly Overview
          </h2>
          <div className="text-gray-400/80 text-sm mb-2 relative z-10">
            Apr 10 - Apr 17
          </div>
          <div className="grid grid-cols-7 gap-2 mt-1 h-20">
            {[
              ...
              >
                <div className="text-gray-400/80 mb-1 text-xs relative z-10">
                  {day}
                </div>
                <div
                  className="w-4 bg-[#4169E1] rounded-t-lg relative transition-all duration-300"
